<form id="post-create-url" action="{{ route('api-qrcode-create') }}" class="border-2 border-green-500 rounded p-4 mt-4 bg-green-100" method="POST" target="_new" enctype="multipart/form-data" >
    ...
    <div class="mt-4 grid grid-cols-none gap-4">
        <div>    
            ...
            <x-input type="file" name="logo"></x-input>
        </div>
    </div>
    <div class="mt-4 grid grid-cols-2 gap-4">
        <div>    
